...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <tr style="color: red;  padding: 10px;">
        ...
        <tr style="background-color:skyblue; padding: 10px; border: 2px; " >
    
    <td>{{$data->name}}</td>
    <td>{{$data->phone}}</td>
    <td>{{$data->speciality}}</td>
    <td>{{$data->room}}</td>
    <td><img src="{{asset('uploads/doctors/'.$data->image)}}" alt="" height="50px" width="50px"></td>
    <td><a href="{{route('updatedoctor',$data->id)}}" class="btn btn-primary">Update</a></td>
    <td><a href="{{route('deletedoctor',$data->id)}}" class="btn btn-danger">Delete</a></td>
